...
<button style="background-color: white" onclick="history.back()">Go Back</button> 
   <div align="center">
        <table style="background-color: #dceeee" border="1" cellpadding="5">
            <caption><h2>Current Listing of NFTs</h2></caption>
            <tr>
            	<th>NFT ID</th>
				<th>NFT name</th>
				<th>Current Owner</th>
                ...
                <th>Price</th>
                <th>Actions</th>
                <th><a href="buy?nftid=<c:out value='${nfts.nftid}' />">BUY</a></th>
            ...
            <c:forEach var="nfts" items="${listNft}">
                <tr style="text-align:center">
                    ...
                    <td>
                        <a href="buy?nftid=<c:out value='${nfts.nftid}' />">BUY</a>
                    </td>
                </tr>
            </c:forEach>
        </table>
